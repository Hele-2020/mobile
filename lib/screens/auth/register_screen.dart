...
class RegisterScreenState extends State<StatefulWidget> {
  ...
  void _registerAsync() async {
    setState(() {
      _registerButtonState = HeleButtonState.loading;
      _error = null;
    });
    try {
      APIResponse res = await heleHttpService.call('register', body: {
        'phone': this._phone,
      ...
      setState(() {
        _registerButtonState = HeleButtonState.success;
        _error = null;
      });
  ...
  Widget _setupTosCheckbox() {
    return Row(mainAxisAlignment: MainAxisAlignment.start, children: <Column>[
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Container(margin: EdgeInsets.all(20.0), child: _setupForm()),
        ));
  }
}
